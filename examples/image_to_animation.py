...
if __name__ == '__main__':
    ...
    skeleton_json_loc = sys.argv[3]    # 사용자 정의 스켈레톤 JSON 경로
    ...
    # Change the retargetting /config/bvh yaml file according to the dance motion
    ...
    # 전체 파이프라인 실행
    image_to_animation(img_fn, char_anno_dir, motion_cfg_fn, retarget_cfg_fn, skeleton_json_loc)
