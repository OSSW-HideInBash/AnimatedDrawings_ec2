...
def test_single_triangle_mesh():
    ...
    vertices = np.array([[2.0, 2.0], [3.0, 3.0], [4.0, 2.0]])
    ...
    assert np.isclose(v, np.array([[-5.0, 0.0], [0.0, 1.0], [5.0, 0.0]])).all()
    ...
    assert np.isclose(
        ...
        np.array(
            [
                ...
                [9.97157285e-01, 1.41137085e00],
                [1.70000001e00, 7.00000011e-01],
            ]
        ),
    ).all()
    ...
    assert np.isclose(
        ...
        np.array(
            [
                ...
                [6.78428061e-01, 1.37166545e00],
                [2.14606263e00, 1.19790398e00],
                [2.81917351e00, 1.12790606e-02],
                [3.95163838e00, 1.34725960e00],
                [5.99999596e00, 5.51801260e-07],
                [8.44193478e-07, 2.99999837e00],
                [1.46633111e00, 2.60720416e00],
                [2.82413859e00, 2.62209072e00],
            ]
        ),
    ).all()
